 ...
 */
	...
	(function(a) {
		...
		function m(a, b) {
			if (a.__loaded)
				...
				K && "style" === a.localName || a.addEventListener("error", d)
			}
		}
		function h(a) {
		...
		function l(a) {
			r(k(a, "template"), function(a) {
				r(k(a.content, 'script:not([type]),script[type="application/javascript"],script[type="text/javascript"]'),
				function(a) {
		...
		function k(a, b) {
			return a.childNodes.length ? a.querySelectorAll(b) : wa
		}
		function r(a, b, d) {
			var c = a ? a.length : 0,
				e = d ? -1 : 1;
			for (d = d ? c - 1 : 0; d < c && 0 <= d; d += e)
				b(a[d], d)
		}
			...
			t = {
				I: function(a, b) {
					...
					if ("style" === a.localName) {
						var d = t.C(a.textContent, b, xa);
						a.textContent = t.C(d, b, ya)
					}
				},
				C: function(a, b, d) {
					return a.replace(d,
				...
				j: function(a, b) {
					if (void 0 === t.l) {
						...
						try {
							...
							d.pathname = "c%20d";
							t.l = "http://a/c%20d" === d.href
						} catch (Ta) {}
					}
					if (t.l)
						return (new URL(a, b)).href;
					d = t.F;
					d || (d = document.implementation.createHTMLDocument("temp"), t.F = d, d.w = d.createElement("base"), d.head.appendChild(d.w), d.v = d.createElement("a"));
					d.w.href = b;
					d.v.href = a;
					return d.v.href || a
				}
		...
		g.prototype.A = function(a) {
			...
			if (void 0 !== this.a[d]) {
				var c = this.a[d];
				c && c.__loaded && (a.__import = c, this.g(a))
			} else
				this.b++, this.a[d] = "pending", Z.load(d, function(a, c) {
					a = b.L(a, c || d);
					b.a[d] = a;
					b.b--;
					b.loadImports(a);
		...
		g.prototype.L = function(a, b) {
			...
			K && (a = a.replace(za, function(a, b, d) {
				return -1 === a.indexOf("type=") ?
				b + " type=import-disable " + d : a
			}));
			...
			if (d = a.querySelector("base"))
				b = t.j(d.getAttribute("href"), b), d.removeAttribute("href");
			var c = 0;
			r(k(a, 'link[rel=import],link[rel=stylesheet][href][type=import-disable],style:not([type]),link[rel=stylesheet][href]:not([type]),script:not([type]),script[type="application/javascript"],script[type="text/javascript"]'),
			function(a) {
				m(a);
				t.I(a, b);
		...
		g.prototype.B = function() {
			...
			if (!this.b) {
				...
				var b = !1,
					d = !1,
					c = function() {
						d && b && (a.loadImports(document), a.b || (a.c.observe(document.head, {
							childList: !0,
							subtree: !0
						}), a.J()))
					};
		...
		g.prototype.flatten = function(a) {
			...
			r(k(a, "link[rel=import]"), function(a) {
				var d = b.a[a.href];
				(a.__import = d) && d.nodeType === Node.DOCUMENT_FRAGMENT_NODE && (b.a[a.href] = a, a.readyState = "loading", a.__import = a, b.flatten(d), a.appendChild(d))
			})
		};
		g.prototype.M = function(a) {
			...
			var d = k(document, "script[import-dependency]"),
				c = d.length;
			b(0)
		};
		g.prototype.N = function(a) {
			var b = k(document, "style[import-dependency],link[rel=stylesheet][import-dependency]"),
				d = b.length;
			if (d) {
				var e = K && !!document.querySelector("link[rel=stylesheet][href][type=import-disable]");
				r(b, function(b) {
					m(b, function() {
		...
		g.prototype.J = function() {
			var a = this;
			r(k(document, "link[rel=import]"), function(b) {
				return a.g(b)
			}, !0)
		};
		...
		g.prototype.K = function(a) {
			...
			r(a, function(a) {
				return r(a.addedNodes, function(a) {
					a && a.nodeType === Node.ELEMENT_NODE && (h(a) ? b.A(a) : b.loadImports(a))
				})
			})
		};
		var M = null;
		if (J)
			r(k(document, "link[rel=import]"), function(a) {
				a.import && "loading" === a.import.readyState || (a.__loaded = !0)
			}), A = function(a) {
				a = a.target;
				h(a) && (a.__loaded = !0)
			}, document.addEventListener("load", A, !0), document.addEventListener("error", A, !0);
		else {
			var B = Object.getOwnPropertyDescriptor(Node.prototype, "baseURI");
			Object.defineProperty((!B ||
			B.configurable ? Node : Element).prototype, "baseURI", {
				get: function() {
	...
	F.prototype.a = function(a, b) {
		...
		ca(this.f, a, b);
		this.s.push(b);
		this.h || (this.h = !0, this.o(function() {
			return ha(c)
		}))
	};
	function ha(a) {
		if (!1 !== a.h) {
			a.h = !1;
			for (var b = a.s, c = [], d = new Map, e = 0; e < b.length; e++)
				d.set(b[e].localName, []);
			D(a.f, document, {
				D: function(b) {
					if (void 0 === b.__CE_state) {
	...
	F.prototype.b = function(a) {
		...
		b = new ea;
		this.u.set(a, b);
		this.f.a.get(a) && !this.s.some(function(b) {
	...
	var G = window.Document.prototype.createElement,
		...
		Aa = window.Element.prototype.insertAdjacentElement,
		Ba = window.Element.prototype.prepend,
		Ca = window.Element.prototype.append,
		R = window.Element.prototype.before,
		Da = window.Element.prototype.after,
		Ea = window.Element.prototype.replaceWith,
		Fa = window.Element.prototype.remove,
		Ga = window.HTMLElement,
		S = Object.getOwnPropertyDescriptor(window.HTMLElement.prototype, "innerHTML"),
		Ha = window.HTMLElement.prototype.insertAdjacentElement;
	var Ia = new function() {};
	function Ja() {
		var a = T;
		window.HTMLElement = function() {
			function b() {
				...
				if (0 === e.length)
					return e = G.call(document, d.localName), Object.setPrototypeOf(e, b.prototype), e.__CE_state = 1, e.__CE_definition = d, x(a, e), e;
				d = e.length - 1;
				var f = e[d];
				if (f === Ia)
		...
		function d(b) {
			return function(d) {
				...
				for (var f = [], l = 0; l < c.length; l++) {
					var k = c[l];
					k instanceof Element && n(k) && f.push(k);
				...
				if (n(this))
					for (c = 0; c < e.length; c++)
						f = e[c], f instanceof Element && y(a, f)
			}
		}
	...
	function La() {
		...
		u(Node.prototype, "cloneNode", function(b) {
			b = oa.call(this, b);
			this.ownerDocument.__CE_hasRegistry ? D(a, b) : w(a,
			b);
			return b
		});
		...
		N && N.get ? b(Node.prototype, N) : da(a, function(a) {
			b(a, {
				enumerable: !0,
				configurable: !0,
				get: function() {
	...
	function Ma(a) {
		...
		function c(b) {
			return function(d) {
				...
				if (n(this))
					for (c = 0; c < e.length; c++)
						h = e[c], h instanceof Element && y(a, h)
			}
		}
		void 0 !== R && (b.before = c(R));
		void 0 !== R && (b.after = c(Da));
		void 0 !== Ea &&
		u(b, "replaceWith", function(b) {
			...
			for (var m = [], h = 0; h < d.length; h++) {
				var g = d[h];
				g instanceof Element && n(g) && m.push(g);
			...
			for (d = 0; d < m.length; d++)
				C(a, m[d]);
			if (h)
				for (C(a, this), d = 0; d < c.length; d++)
					m = c[d], m instanceof Element && y(a, m)
		});
		void 0 !== Fa && u(b, "remove", function() {
			var b = n(this);
			Fa.call(this);
			b && C(a, this)
		})
	...
	function Na() {
		...
		ra && u(Element.prototype, "attachShadow", function(a) {
			return this.__CE_shadowRoot = a = ra.call(this, a)
		});
		O && O.get ? b(Element.prototype, O) : S && S.get ? b(HTMLElement.prototype, S) : da(a, function(a) {
			b(a, {
				enumerable: !0,
				configurable: !0,
				get: function() {
				...
				set: function(a) {
					var b = "template" === this.localName,
						...
						c = G.call(document, this.localName);
					for (c.innerHTML = a; 0 < d.childNodes.length;)
						I.call(d, d.childNodes[0]);
		...
		u(Element.prototype, "removeAttributeNS", function(b, c) {
			if (1 !== this.__CE_state)
				return va.call(this, b, c);
			var d = Q.call(this, b, c);
			va.call(this, b, c);
			var e = Q.call(this, b, c);
			d !== e && a.attributeChangedCallback(this, c, d, e, b)
		});
		Ha ? c(HTMLElement.prototype, Ha) : Aa ? c(Element.prototype, Aa) : console.warn("Custom Elements: `Element#insertAdjacentElement` was not patched.");
	...
	if (!V || V.forcePolyfill || "function" != typeof V.define || "function" != typeof V.get) {
		...
		Ja();
		Ka();
		U(T, DocumentFragment.prototype, {
			i: ma,
			append: na
		});
		La();
 ...
 */
	...
	var W = window.customElements,
		...
		Oa = window.HTMLTemplateElement;
	window.WebComponents = window.WebComponents || {};
	if (W && W.polyfillWrapFlushCallback) {
		var Y,
			Pa = function() {
				if (Y) {
					Oa.H && Oa.H(window.document);
					var a = Y;
					Y = null;
					a();
					return !0
	...
	var Ra = document.createElement("style");
	Ra.textContent = "body {transition: opacity ease-in 0.2s; } \nbody[unresolved] {opacity: 0; display: block; overflow: hidden; position: relative; } \n";
	var Sa = document.querySelector("head");
